...
if [ `uname -m` == 'aarch64' ]; then
 ...
 declare -A python_map=( ["3.6"]="cp36-cp36m" ["3.7"]="cp37-cp37m" ["3.8"]="cp38-cp38" ["3.9"]="cp39-cp39" ["3.9-nogil"]="nogil39-nogil_39b_x86_64_linux_gnu")
 declare -A python_include=( ["3.6"]="3.6m" ["3.7"]="3.7m" ["3.8"]="3.8" ["3.9"]="3.9" ["3.9-nogil"]="3.9")
